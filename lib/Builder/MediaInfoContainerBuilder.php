...
namespace OCA\MediaInfoLib\Builder;

use OCA\MediaInfoLib\Container\MediaInfoContainer;
use OCA\MediaInfoLib\Factory\AttributeFactory;
use OCA\MediaInfoLib\Factory\TypeFactory;
...
class MediaInfoContainerBuilder
{
     ...
     */
    public function build(): \OCA\MediaInfoLib\Container\MediaInfoContainer
    {
     ...
     *
     * @throws \OCA\MediaInfoLib\Exception\UnknownTrackTypeException
     */
